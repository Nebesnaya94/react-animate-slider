...
export const infoList: ISliderItem[] = [
  {
    ...
    items: [
      {
        date: 1985,
        info: "«Рассказ служанки» / The Handmaid's Tale. Автор: Маргарет Этвуд. Жанры: Роман, Научная фантастика, Фантастика, Антиутопическая литература, Трагедия, Фэнтези",
      },
      {
        date: 1985,
      ...
      {
        date: 1991,
        info: "«Американский психопат» / American Psycho. Автор: Брет Истон Эллис. Жанры: Сатира, Ужасы, Чёрный юмор, Литература постмодернизма, Психологический реализм",
      },
      {
        date: 1996,
